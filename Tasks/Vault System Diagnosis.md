...
| C4  | Task Engine          | 🟢/🟡  | Engine is healthy but action items live in 3 places; `contexts` & recurrence unused; gcal sync silently broken                   | **High** (cheap fix, big return) | 2026-07-02: lane-tagged all 15 tasks (`contexts: work/hub`); confirmed [[Track A — Weekly Deep-Work Block]] as the recurring heartbeat (WE+SA, 4.5h/wk); wrote [[Tagging & Metadata Rules]] + cleaned tag drift; moved 3 stray task files into /Tasks |            |
