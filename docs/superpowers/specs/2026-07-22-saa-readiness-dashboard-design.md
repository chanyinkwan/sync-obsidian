...
6. **Today-scoped pace, never cumulative-deficit.** Two target lines from the existing phase arc in Study Session Protocol: touched 100% by 2026-08-03 (Drill phase start), proven 100% by 2026-08-21 (last day of Mock+repair). The panel converts the tighter line into one sentence for today, e.g. "today: open 2 topics in Resilient to stay on line". It never renders the word BEHIND as a headline.
