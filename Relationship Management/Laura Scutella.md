...
aka:
org: CKHH-IOD (Italy)
role: Quality Assurance Lead, CKHH-IOD (Italy)
location: Italy
languages:
email:
relationship: 1
...
## At a glance
- **Role:** Quality Assurance Lead, CK Hutchison Italy (WindTre) IOD — QA execution for the smartphone-return technical validation.
- **What they care about / their stake:** Test/conformance evidence backing the smartphone-return decision (eSIM, Wi-Fi/BT, ENDC CA, NR/LTE tech specs, protocol conformance).
