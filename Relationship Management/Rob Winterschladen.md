...
type: contact
category: customer
name: Rob Winterschladen
employee_id:
aka:
org: VodafoneThree UK（原 VDF UK 團隊）
role: Consumer（原 VDF UK Consumer Director）
location: UK
languages: English
email:
relationship:
...
## At a glance
- **Role:** Consumer 業務負責人，向 [[Max Taylor (VodafoneThree)|Max Taylor]] 匯報，原為 VDF UK Consumer Director。
